...
define(['react', 'widgets/tab', 'widgets/db_list_mixin'], function(React, Tab, DbListMixin) {
        ...
        render: function() {
            ...
            if (this.state.dbListLoaded && Object.keys(self.state.dbList).length === 0) {
                ...
                component = Object.keys(self.state.dbList).map(function (k) {
                    ...
                    return Tab({ key: k, rev: value._rev, name: value.name, description: value.description });
                });
            }
